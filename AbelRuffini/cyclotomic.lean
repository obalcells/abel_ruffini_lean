...
-- theorem xna_gives_splitting_field {n : ℕ+} (a : K)
--   : IsSplittingField K L (X ^ (n : ℕ) : K[X]) := by {
...
-- theorem gal_kummer_extension_isCyclic
--   (n : ℕ)
--   [Field F]
--   [NeZero ((n : ℕ) : F)]
--   (n_notzero : NeZero ((n : ℕ) : F))
--   (isCyclotomicExtension n_notzero)
--   (a : F)
--   : IsCyclic (adjoin F { b : F | b ^ n = a }).Gal := by {
